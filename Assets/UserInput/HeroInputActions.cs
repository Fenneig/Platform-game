...
public class @HeroInputActions : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Hero"",
            ""id"": ""24becfe0-d4c8-42eb-9572-6bc668e118b2"",
            ""actions"": [
                {
                    ""name"": ""HorizontalMovement"",
                    ""type"": ""Value"",
                    ""id"": ""6eae8c89-7eb0-4a93-b6bf-abc4f6f6793f"",
                ...
                },
                {
                    ""name"": ""SaySomething"",
                    ""type"": ""Button"",
                    ""id"": ""ced06266-d5eb-49c8-9c72-f7d3e886dd98"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": ""Keyboard"",
                    ""id"": ""08f7ca12-d7fd-42e8-88ca-e4945822f308"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Negative"",
                    ""id"": ""f97530cb-9247-4fbe-bbf4-f67dda617293"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Positive"",
                    ""id"": ""30d3f763-b279-4156-9121-3724c2ecb236"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""Arrows"",
                    ""id"": ""f7675aa0-642d-4829-b518-5ae2a91c72d9"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""47835b97-7ab5-44ff-a1d7-283df5521412"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""c6b4ade9-91f3-4c39-8ba2-be87a0bb1000"",
                ...
                {
                    ""name"": """",
                    ""id"": ""185a468c-729c-4a90-b86c-5b03a5115a79"",
